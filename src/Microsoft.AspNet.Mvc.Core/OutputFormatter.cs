...
namespace Microsoft.AspNet.Mvc
{
    ...
    public abstract class OutputFormatter : IOutputFormatter, IApiResponseFormatMetadataProvider
    {
        ...
        /// </summary>
        public static readonly Encoding UTF8EncodingWithoutBOM = InputFormatter.UTF8EncodingWithoutBOM;

        /// <summary>
        /// Returns UTF16 Encoding which uses littleEndian byte order with BOM and throws on invalid bytes.
        /// </summary>
        public static readonly Encoding UTF16EncodingLittleEndian = InputFormatter.UTF16EncodingLittleEndian;
